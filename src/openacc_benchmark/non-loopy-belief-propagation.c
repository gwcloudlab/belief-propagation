...
int main(void) {
     ...
     */
    run_test_belief_propagation_xml_file_acc("/mnt/raid0_huge/micheal/gunrock_benchmark_files_copy/10_20.bif.xml", out);
    run_test_belief_propagation_xml_file_acc("/mnt/raid0_huge/micheal/gunrock_benchmark_files_copy/100_200.bif.xml", out);
    run_test_belief_propagation_xml_file_acc("/mnt/raid0_huge/micheal/gunrock_benchmark_files_copy/1000_2000.bif.xml", out);
    run_test_belief_propagation_xml_file_acc("/mnt/raid0_huge/micheal/gunrock_benchmark_files_copy/10000_20000.bif.xml", out);
    run_test_belief_propagation_xml_file_acc("/mnt/raid0_huge/micheal/gunrock_benchmark_files_copy/100000_200000.bif.xml", out);
    run_test_belief_propagation_xml_file_acc("/mnt/raid0_huge/micheal/gunrock_benchmark_files_copy/200000_400000.bif.xml", out);
    run_test_belief_propagation_xml_file_acc("/mnt/raid0_huge/micheal/gunrock_benchmark_files_copy/400000_800000.bif.xml", out);
    run_test_belief_propagation_xml_file_acc("/mnt/raid0_huge/micheal/gunrock_benchmark_files_copy/800000_1600000.bif.xml", out);
