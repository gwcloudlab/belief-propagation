...
void run_test_loopy_belief_propagation_partitioned_mtx_files(const char * edges_mtx, const char * nodes_mtx, FILE *out) {
    Graph_t graph;
    clock_t start, end;
    double time_elapsed;
    ...
    if(graph->current_num_vertices < num_partitions) {
        ...
        num_iterations = loopy_propagate_until_partitioned(graph, PRECISION, NUM_ITERATIONS, num_partitions);
        end = clock();
    }
    // output data
    time_elapsed = (double)(end - start)/CLOCKS_PER_SEC;
...
void run_test_loopy_belief_propagation_partitioned_replicated_mtx_files(const char * edges_mtx, const char * nodes_mtx, FILE *out) {
    Graph_t graph;
    clock_t start, end;
    double time_elapsed;
    unsigned int num_iterations, num_partitions;
    ...
    if(graph->current_num_vertices < num_partitions) {
        ...
        num_iterations = loopy_propagate_until_partitioned_replicated(graph, PRECISION, NUM_ITERATIONS, num_partitions);
        end = clock();
    }
    // output data
    time_elapsed = (double)(end - start)/CLOCKS_PER_SEC;
...
void run_test_loopy_belief_propagation_partitioned_replicated_mtx_files_acc(const char *edges_mtx, const char *nodes_mtx, FILE *out) {
    Graph_t graph;
    clock_t start, end;
    double time_elapsed;
    unsigned int num_iterations, num_partitions;
    ...
    if(graph->current_num_vertices < num_partitions) {
        ...
        num_iterations = loopy_propagate_until_partitioned_replicated_acc(graph, PRECISION, NUM_ITERATIONS, num_partitions);
        end = clock();
    }
