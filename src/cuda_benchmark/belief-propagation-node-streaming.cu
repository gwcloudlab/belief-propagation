...
int main(void) {
    ...
    run_test_loopy_belief_propagation_mtx_files_cuda_streaming("/home/mjt5v/Desktop/belief-network-const-joint-probability/soc-twitter-2010_32.edges.mtx", "/home/mjt5v/Desktop/belief-network-const-joint-probability/soc-twitter-2010_32.nodes.mtx", &edge_joint_probability, dim_x, dim_y, out);
