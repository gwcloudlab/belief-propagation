...
int main(int argc, char *argv[]) {
    ...
    run_test_loopy_belief_propagation_mtx_files_edge_cuda_openmpi("/home/mjt5v/Desktop/belief-network-const-joint-probability/soc-twitter-2010_32.edges.mtx", "/home/mjt5v/Desktop/belief-network-const-joint-probability/soc-twitter-2010_32.nodes.mtx", &edge_joint_probability, dim_x, dim_y, out, my_rank, n_ranks, num_devices);
