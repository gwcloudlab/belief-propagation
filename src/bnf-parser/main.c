...
*/
    ...
    run_tests_with_file("very_large/andes.bif", 1);
    run_tests_with_file("very_large/diabetes.bif", 1);
    run_tests_with_file("very_large/link.bif", 1);
    run_tests_with_file("very_large/munin1.bif", 1);
    run_tests_with_file("very_large/munin2.bif", 1);
    run_tests_with_file("very_large/munin3.bif", 1);
    run_tests_with_file("very_large/munin4.bif", 1);
    //run_tests_with_file("very_large/pathfinder.bif", 1);
    run_tests_with_file("very_large/pigs.bif", 1);
